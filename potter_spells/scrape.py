...
def get_spells():
	...
	detail = {'name':'Legilimens',
                  'full_name':'Legilimens (Legilimency Spell)',
                  'type':'Type: Charm ',
                  'pron':'Pronunciation: Le-JIL-ih-mens',
                  'desc':'Description: Allows the caster to delve into the mind of the victim, allowing the caster to see the memories, thoughts, and emotions of the victim.'}
